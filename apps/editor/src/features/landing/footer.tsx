            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid gap-8 grid-cols-4 lg:grid-cols-6">
                    ...
                    <div className="col-span-4 lg:col-span-2 max-w-2xl">
                        ...
                        <p className="text-muted-foreground mb-6 max-lg:text-center max-lg:flex max-lg:justify-center">
                            Accelerating web development with curated blocks, templates, landing
                            pages, and admin dashboards designed for modern developers.
                        </p>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
                    <div className="flex flex-col sm:flex-row items-center gap-2 text-muted-foreground text-sm">
                        ...
                        <span>© {CURRENT_YEAR} Keycloak Theme Editor</span>
                    </div>
