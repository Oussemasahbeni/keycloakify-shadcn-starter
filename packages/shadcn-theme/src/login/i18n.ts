...
const { I18nProvider, useI18n } = i18nBuilder
    ...
    .withCustomTranslations({
        ...
        ca: {
            welcomeMessage:
                "La vostra porta d'accés segura a una experiència fluida.",
            ...
            'organization.pickPlaceholder':
                'Trieu una organització per continuar',
        ...
        da: {
            ...
            'organization.pickPlaceholder':
                'Vælg en organisation for at fortsætte',
            ...
            usernameOrEmailPlaceholder:
                'Indtast dit brugernavn eller din e-mail',
        ...
        el: {
            ...
            'organization.pickPlaceholder':
                'Επιλέξτε έναν οργανισμό για να συνεχίσετε',
            ...
            usernameOrEmailPlaceholder:
                'Εισαγάγετε το όνομα χρήστη ή το email σας',
        ...
        es: {
            welcomeMessage:
                'Su puerta de acceso segura a una experiencia perfecta.',
            ...
            'organization.pickPlaceholder':
                'Elija una organización para continuar',
        ...
        fa: {
            ...
            'organization.pickPlaceholder':
                'برای ادامه یک سازمان را انتخاب کنید',
        ...
        fr: {
            welcomeMessage:
                'Votre passerelle sécurisée vers une expérience sans faille.',
            ...
            usernameOrEmailPlaceholder:
                "Entrez votre nom d'utilisateur ou votre e-mail",
        ...
        hu: {
            welcomeMessage:
                'Az Ön biztonságos kapuja a zökkenőmentes élményhez.',
            ...
            'organization.pickPlaceholder':
                'A folytatáshoz válasszon egy szervezetet',
            ...
            usernameOrEmailPlaceholder:
                'Adja meg a felhasználónevét vagy e-mail-címét',
        ...
        it: {
            welcomeMessage:
                "Il tuo accesso sicuro a un'esperienza senza interruzioni.",
            ...
            'organization.pickPlaceholder':
                "Scegli un'organizzazione per continuare",
            ...
            usernameOrEmailPlaceholder:
                'Inserisci il tuo nome utente o la tua email',
        ...
        ka: {
            ...
            'organization.pickPlaceholder':
                'გასაგრძელებლად აირჩიეთ ორგანიზაცია',
        ...
        lt: {
            ...
            'organization.pickPlaceholder':
                'Norėdami tęsti, pasirinkite organizaciją',
            ...
            usernameOrEmailPlaceholder:
                'Įveskite savo vartotojo vardą arba el. paštą',
        ...
        lv: {
            ...
            'organization.pickPlaceholder':
                'Izvēlieties organizāciju, lai turpinātu',
            ...
            usernameOrEmailPlaceholder:
                'Ievadiet savu lietotājvārdu vai e-pastu',
        ...
        nl: {
            welcomeMessage:
                'Uw veilige toegangspoort tot een naadloze ervaring.',
            ...
            'organization.pickPlaceholder':
                'Kies een organisatie om verder te gaan',
        ...
        no: {
            ...
            'organization.pickPlaceholder':
                'Velg en organisation for å fortsette',
        ...
        pl: {
            welcomeMessage:
                'Twoja bezpieczna brama do bezproblemowego korzystania.',
            ...
            'organization.pickPlaceholder':
                'Wybierz organizację, aby kontynuować',
            ...
            usernameOrEmailPlaceholder:
                'Wprowadź swoją nazwę użytkownika lub e-mail',
        ...
        pt: {
            welcomeMessage:
                'A sua porta de entrada segura para uma experiência perfeita.',
            ...
            usernameOrEmailPlaceholder:
                'Insira o seu nome de utilizador ou e-mail',
        ...
        ru: {
            ...
            'organization.pickPlaceholder':
                'Выберите организацию, чтобы продолжить',
        ...
        sk: {
            ...
            usernameOrEmailPlaceholder:
                'Zadajte svoje používateľské meno alebo e-mail',
        ...
        sv: {
            ...
            'organization.pickPlaceholder':
                'Välj en organisation för att fortsätta',
        ...
        uk: {
            ...
            'organization.pickPlaceholder':
                'Виберіть організацію, щоб продовжити',
        ...
        az: {
            ...
            'organization.pickPlaceholder':
                'Davam etmək üçün bir təşkilat seçin',
            'identity-provider-login-last-used': 'Son',
        ...
        eu: {
            welcomeMessage:
                'Esperientzia ezin hobea izateko zure atari segurua.',
            ...
            usernameOrEmailPlaceholder:
                'Sartu zure erabiltzaile-izena edo posta elektronikoa',
        ...
        hr: {
            ...
            'organization.pickPlaceholder':
                'Odaberite organizaciju za nastavak',
            ...
            usernameOrEmailPlaceholder:
                'Unesite svoje korisničko ime ili e-poštu',
        ...
        hy: {
            ...
            'organization.pickPlaceholder':
                'Շարունակելու համար ընտրեք կազմակերպություն',
            ...
            usernameOrEmailPlaceholder:
                'Մուտքագրեք ձեր օգտանունը կամ էլ. փոստը',
        ...
        ky: {
            ...
            usernameOrEmailPlaceholder:
                'Колдонуучу атыңызды же электрондук почтаңызды жазыңыз',
        ...
        ro: {
            welcomeMessage:
                'Poarta ta sigură către o experiență fără probleme.',
            ...
            'organization.pickPlaceholder':
                'Alegeți o organizație pentru a continua',
            ...
            usernameOrEmailPlaceholder:
                'Introduceți numele de utilizator sau e-mailul',
        ...
        vi: {
            welcomeMessage:
                'Cổng vào an toàn của bạn cho trải nghiệm liền mạch.',
